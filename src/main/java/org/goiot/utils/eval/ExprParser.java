...
import org.goiot.utils.eval.functor.FuncAbs;
import org.goiot.utils.eval.functor.FuncAcos;
import org.goiot.utils.eval.functor.FuncAnd;
import org.goiot.utils.eval.functor.FuncAsin;
import org.goiot.utils.eval.functor.FuncAtan;
import org.goiot.utils.eval.functor.FuncAtan2;
import org.goiot.utils.eval.functor.FuncCbrt;
import org.goiot.utils.eval.functor.FuncCeil;
import org.goiot.utils.eval.functor.FuncCos;
import org.goiot.utils.eval.functor.FuncCosh;
import org.goiot.utils.eval.functor.FuncExp;
import org.goiot.utils.eval.functor.FuncExpm1;
import org.goiot.utils.eval.functor.FuncFalse;
import org.goiot.utils.eval.functor.FuncFloor;
import org.goiot.utils.eval.functor.FuncGaussion;
import org.goiot.utils.eval.functor.FuncHypot;
import org.goiot.utils.eval.functor.FuncIf;
import org.goiot.utils.eval.functor.FuncInt;
import org.goiot.utils.eval.functor.FuncLog;
import org.goiot.utils.eval.functor.FuncLog10;
import org.goiot.utils.eval.functor.FuncLog1p;
import org.goiot.utils.eval.functor.FuncMax;
import org.goiot.utils.eval.functor.FuncMin;
import org.goiot.utils.eval.functor.FuncNot;
import org.goiot.utils.eval.functor.FuncOr;
import org.goiot.utils.eval.functor.FuncPow;
import org.goiot.utils.eval.functor.FuncRandom;
import org.goiot.utils.eval.functor.FuncRint;
import org.goiot.utils.eval.functor.FuncRound;
import org.goiot.utils.eval.functor.FuncSin;
import org.goiot.utils.eval.functor.FuncSinh;
import org.goiot.utils.eval.functor.FuncSqrt;
import org.goiot.utils.eval.functor.FuncStrCat;
import org.goiot.utils.eval.functor.FuncStrCmp;
import org.goiot.utils.eval.functor.FuncStrLeft;
import org.goiot.utils.eval.functor.FuncStrLen;
import org.goiot.utils.eval.functor.FuncStrLower;
import org.goiot.utils.eval.functor.FuncStrMid;
import org.goiot.utils.eval.functor.FuncStrReplace;
import org.goiot.utils.eval.functor.FuncStrRight;
import org.goiot.utils.eval.functor.FuncStrSubstitute;
import org.goiot.utils.eval.functor.FuncStrT;
import org.goiot.utils.eval.functor.FuncStrUpper;
import org.goiot.utils.eval.functor.FuncStrValue;
import org.goiot.utils.eval.functor.FuncSwitch;
import org.goiot.utils.eval.functor.FuncTan;
import org.goiot.utils.eval.functor.FuncTanh;
import org.goiot.utils.eval.functor.FuncToDegrees;
import org.goiot.utils.eval.functor.FuncToRadians;
import org.goiot.utils.eval.functor.FuncTrue;
import org.goiot.utils.eval.functor.FuncUlp;
...
public class ExprParser {
	...
	private static void InitDefaultOperator() {
		...
		TableManager.regOperator(new Operator("!按位异或", "^", 10, 2, new BitwiseExclusiveOrHandler()));

		TableManager.regOperator(new Operator("!按位与", "&", 9, 2, new BitwiseAndHanlder()));
		TableManager.regOperator(new Operator("!按位或", "|", 11, 2, new BitwiseInclusiveOrHandler()));
		TableManager.regOperator(new Operator("!按位非", "~", 2, 1, new BitwiseNegationHandler()));

		TableManager.regOperator(new Operator("!逻辑与", "&&", 12, 2, new LogicalAndHandler()));
		TableManager.regOperator(new Operator("!逻辑或", "||", 13, 2, new LogicalOrHandler()));
		TableManager.regOperator(new Operator("!逻辑非", "!", 2, 1, new LogicalNegationHandler()));
	...
	private static void InitGlobalFunctor() {
		...
		TableManager.regGlobalFunction(new FuncAcos());
		TableManager.regGlobalFunction(new FuncAnd());
		TableManager.regGlobalFunction(new FuncAsin());
		TableManager.regGlobalFunction(new FuncAtan());
		TableManager.regGlobalFunction(new FuncAtan2());
		TableManager.regGlobalFunction(new FuncCbrt());
		TableManager.regGlobalFunction(new FuncCeil());
		TableManager.regGlobalFunction(new FuncCos());
		TableManager.regGlobalFunction(new FuncCosh());
		TableManager.regGlobalFunction(new FuncExp());
		TableManager.regGlobalFunction(new FuncExpm1());
		TableManager.regGlobalFunction(new FuncFalse());
		TableManager.regGlobalFunction(new FuncFloor());
		TableManager.regGlobalFunction(new FuncHypot());
		TableManager.regGlobalFunction(new FuncIf());
		TableManager.regGlobalFunction(new FuncLog());
		TableManager.regGlobalFunction(new FuncLog10());
		TableManager.regGlobalFunction(new FuncLog1p());
		TableManager.regGlobalFunction(new FuncMax());
		TableManager.regGlobalFunction(new FuncMin());
		TableManager.regGlobalFunction(new FuncNot());
		TableManager.regGlobalFunction(new FuncOr());
		...
		TableManager.regGlobalFunction(new FuncRint());
		TableManager.regGlobalFunction(new FuncSin());
		TableManager.regGlobalFunction(new FuncSinh());
		TableManager.regGlobalFunction(new FuncSqrt());
		TableManager.regGlobalFunction(new FuncStrCat());
		TableManager.regGlobalFunction(new FuncStrCmp());
		TableManager.regGlobalFunction(new FuncStrLeft());
		TableManager.regGlobalFunction(new FuncStrLen());
		TableManager.regGlobalFunction(new FuncStrLower());
		TableManager.regGlobalFunction(new FuncStrMid());
		TableManager.regGlobalFunction(new FuncStrReplace());
		TableManager.regGlobalFunction(new FuncStrRight());
		TableManager.regGlobalFunction(new FuncStrSubstitute());
		TableManager.regGlobalFunction(new FuncStrT());
		TableManager.regGlobalFunction(new FuncStrUpper());
		TableManager.regGlobalFunction(new FuncStrValue());
		TableManager.regGlobalFunction(new FuncSwitch());
		TableManager.regGlobalFunction(new FuncTan());
		TableManager.regGlobalFunction(new FuncTanh());
		TableManager.regGlobalFunction(new FuncToDegrees());
		TableManager.regGlobalFunction(new FuncToRadians());
		TableManager.regGlobalFunction(new FuncTrue());
		TableManager.regGlobalFunction(new FuncUlp());
		TableManager.regGlobalFunction(new FuncInt());
